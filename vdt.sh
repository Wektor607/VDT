...
torchrun --nproc_per_node=2 train.py --model VDT-S/2 --vae mse --image-size 128 --f None \
        --num-classes 1 --batch_size 2 --cfg-scale 4 --num-sampling-steps 16 --seed 0 \
        --num_frames 30 --epoch 100
